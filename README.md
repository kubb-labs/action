...
The pull-request comment links to the installable package and its Studio agent, so reviewers can inspect the generated result without recreating the workflow locally. See the [Kubb Studio guide](https://kubb.dev/docs/5.x/guide/integrations/studio), the [GitHub Actions guide](https://kubb.dev/docs/5.x/guide/integrations/github-actions), and the [local-first model](https://kubb.dev/docs/5.x/guide/concepts/local-first).
